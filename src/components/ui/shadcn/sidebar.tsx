...
type SidebarTriggerProps = Omit<React.ComponentProps<typeof Button>, "variant" | "size">;

function SidebarTrigger({ className, onClick, ...props }: Readonly<SidebarTriggerProps>) {
...
function SidebarInput({ className, ...props }: Readonly<Omit<React.ComponentProps<typeof Input>, "type">>) {
  return (
    <Input
...
type SidebarMenuButtonProps = React.ComponentProps<"button"> & {
  ...
  size?: "default" | "sm" | "lg";
  tooltip?: string | Omit<React.ComponentProps<typeof TooltipContent>, "side" | "align" | "hidden">;
};
...
function SidebarMenuButton({
  ...
  const tooltipClassName = typeof tooltip === "string" ? "" : tooltip.className || "";
