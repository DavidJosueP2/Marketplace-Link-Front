  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.success("Usuario actualizado", {
        description: `Los datos de ${formData.firstName || user.firstName} han sido actualizados correctamente.`,
        duration: 3000,
      });
      ...
      if (backendErrors && typeof backendErrors === "object") {
        ...
        const message = apiError?.payload?.message || apiError?.message || "Error al actualizar el usuario";
        ...
        <div className="sticky top-0 bg-background border-b border-border px-6 py-4 flex items-center justify-between z-10">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Actualizando información de {user.fullName}
            </p>
          </div>
          <button
            onClick={handleClose}
