...
interface FeedbackProps { message: string }
function Feedback({ message }: Readonly<FeedbackProps>) {
...
export default function Login() {
  ...
  const { login, isAuthenticated } = useAuth() as {
    login: (e: string, p: string) => Promise<{ success: boolean; errorData?: { message?: string; details?: string } }>;
      ...
      <div className="relative flex items-center justify-center min-h-[100dvh] px-4 sm:px-8 py-6 sm:py-8">
        <div className="relative h-[70vh] sm:h-[72vh] w-full sm:w-[92%] lg:w-[70%] xl:w-[60%] max-w-4xl rounded-2xl overflow-hidden">
          ...
          <div className="relative h-full flex flex-col items-center justify-center gap-10 px-6 sm:px-12 md:px-16 text-center">
            ...
            <form className="w-full max-w-md md:max-w-lg text-left grid gap-5" onSubmit={handleSubmit} autoComplete="on">
              ...
              <div className="grid gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/password-recovery" className="text-xs underline underline-offset-4 text-muted-foreground hover:text-foreground transition-colors">
              ...
              <p className="text-xs text-muted-foreground text-center">
                ...
                <Link to="/register" className="underline underline-offset-4 text-muted-foreground hover:text-foreground transition-colors">
                  Regístrate
                </Link>
              </p>
            </form>
