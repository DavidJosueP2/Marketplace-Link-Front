...
import StepAccount from "./register/components/StepAccount";
import StepProfile from "./register/components/StepProfile";
import StepLocation from "./register/components/StepLocation";
